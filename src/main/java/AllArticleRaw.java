...
public class AllArticleRaw {
	...
	public static void main(String[] args) throws Exception{
		...
		//String[] pageNames = {"2013–14 Israeli–Palestinian peace talks"};
		String[] pageNames = {"2014 Gaza war beach bombing incidents"};
		...
		for (String pageName : pageNames) {
			String outCsvName = "ipc_articles_raw/" + pageName.replaceAll(" ", "_").replaceAll("/", "_").toLowerCase() + ".tsv";
			...
			if (!pageFile.exists()) {
				...
				try {
					...
					for (int i = 0; i < actualTimestamps.size(); i++) {
						...
						String[] line = {pageName, date, revText, revisionEditor, revisionComment};
